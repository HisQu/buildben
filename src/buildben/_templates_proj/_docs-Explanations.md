...
Prefer explicit configuration surfaces:

- document environment variables before users need them
- keep defaults close to the code that owns them
- use dataclasses for structured config when they improve clarity
- avoid generic fallback probes against strict domain objects

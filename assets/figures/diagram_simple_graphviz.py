"""Render the simplified Buildben dependency-management figure."""
...
FIGURE_NAME = "diagram-simple-graphviz"
...
def export_figure(
    ...
    return export_single_graph_figure(
        ...
        size_policy=DEPENDENCY_MANAGEMENT_SIMPLE_POLICY,
    )
...
def main() -> int:
    ...
    return run_single_graph_cli(
        export_figure,
        description="Render the simplified Buildben dependency-management figure.",
    )
